...
!function () {
  ...
  d.get = function (a) {
    var b;
    if (f[a]) b = f[a];else if ("object" == (typeof document === "undefined" ? "undefined" : _typeof(document))) {
  ...
  var h = function h(a, b) {
    return "string" != typeof a && (b = _typeof(a), "number" === b ? a += "" : a = "function" === b ? h(a.call(a)) : ""), a;
  },
      i = {
    "<": "&#60;",
    ">": "&#62;",
    ...
    return "[object Array]" === {}.toString.call(a);
      ...
      m = function m(a, b) {
    var c, d;
    if (l(a)) for (c = 0, d = a.length; d > c; c++) {
      b.call(a, a[c], c, a);
    } else for (c in a) {
      b.call(a, a[c], c);
    }
